...
let HealthIndicators = class HealthIndicators extends LitElement {
    constructor() {
        super();
        this.patientDashboardWeight = [];
        this.patientDashboardHeartRate = [];
        this.patientDashboardBPSystolicDiastolic = [];
        this.patientDashboardGlucose = [];
        this.patientDashboardTotalCholesterol = [];
        this.patientDashboardCholesterolHDLLDL = [];
...
__decorate([
    state()
], HealthIndicators.prototype, "patientDashboardWeight", void 0);
__decorate([
    state()
], HealthIndicators.prototype, "patientDashboardHeartRate", void 0);
__decorate([
    state()
], HealthIndicators.prototype, "patientDashboardBPSystolicDiastolic", void 0);
__decorate([
    state()
], HealthIndicators.prototype, "patientDashboardGlucose", void 0);
__decorate([
    state()
], HealthIndicators.prototype, "patientDashboardTotalCholesterol", void 0);
__decorate([
    state()
], HealthIndicators.prototype, "patientDashboardCholesterolHDLLDL", void 0);
HealthIndicators = __decorate([
