...
let Appointments = class Appointments extends LitElement {
    render() {
        return html `
      ...
      <div class="row-layout group_8">
        <div class="column-layout group_1">
          ...
          <div class="row-layout group_13">
            <igc-button variant="flat" type="button" @click="${() => { var _a; return (_a = this.cancelApptDialog) === null || _a === void 0 ? void 0 : _a.toggle(); }}" class="button">
      ...
      <igc-dialog ?close-on-outside-click="${true}" id="cancel-appt-dialog">
        ...
        <div slot="footer">
          <igc-button variant="flat" type="button" @click="${() => { var _a; return (_a = this.cancelApptDialog) === null || _a === void 0 ? void 0 : _a.toggle(); }}" class="button_1">
            No, go back
            <igc-ripple></igc-ripple>
          </igc-button>
          <igc-button variant="flat" type="button" @click="${() => { var _a; return (_a = this.cancelApptDialog) === null || _a === void 0 ? void 0 : _a.toggle(); }}" class="button_1 button_1_1">
            Yes, cancel
            <igc-ripple></igc-ripple>
          </igc-button>
        </div>
...
Appointments.styles = css `
    ...
    .button_1_1::part(base) {
      ...
      background-color: hsla(var(--ig-error-500));
    }
  `;
__decorate([
    query('#cancel-appt-dialog')
], Appointments.prototype, "cancelApptDialog", void 0);
